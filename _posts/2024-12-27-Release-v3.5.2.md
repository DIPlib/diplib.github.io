...
*DIPlib* 3.5.2 was released today. It includes some assorted improvements and bug fixes.
Please see the [change log](/changelogs/diplib_3.5.2.html) for details.
...
We support Python 3.10 through 3.13, on Windows (x86_64), Linux (x86_64) and macOS (x86_64 and aarch64).
